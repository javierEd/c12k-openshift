class Cuenta
  ...
  attr_accessor :login, :ent_doc_id, :ent_nombre, :ent_apellidos, :ent_fecha_nac, :ent_sexo, :ent_email, :ent_rol #, :ent_pais, :entidad_federal, :localidad, :direccion, :terminos
  ...
  validates_presence_of :ent_rol, unless: 'administrador'
  
  validates_presence_of :ent_doc_id, unless: 'administrador'
  validates_presence_of :ent_nombre, unless: 'administrador'
  validates_presence_of :ent_apellidos, unless: 'administrador'
  validates_presence_of :ent_email, unless: 'administrador'
